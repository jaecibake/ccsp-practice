...
const CERT_DATA = {
  ccsp:  { name:'CCSP',  fullName:'Certified Cloud Security Professional',       org:'ISC²',  icon:'☁️',  color:'#4f8ef7', accentDark:'#3a6fd8',
           getQ:()=>[...QUESTIONS_CCSP,
             ...
             ...(typeof QUESTIONS_CCSP_C6!=='undefined'?QUESTIONS_CCSP_C6:[])],
           getDN:()=>(typeof DOMAIN_NAMES_CCSP!=='undefined'?DOMAIN_NAMES_CCSP:{}),
           getAcr:()=>(typeof ACRONYMS_CCSP!=='undefined'?ACRONYMS_CCSP:[]),
           getGls:()=>(typeof GLOSSARY_CCSP!=='undefined'?GLOSSARY_CCSP:[]),
  ...
  cism:  { name:'CISM',  fullName:'Certified Information Security Manager',       org:'ISACA', icon:'🔒',  color:'#27ae60', accentDark:'#1e8449',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_CISM!=='undefined'?DOMAIN_NAMES_CISM:{}),
           getAcr:()=>(typeof ACRONYMS_CISM!=='undefined'?ACRONYMS_CISM:[]),
           getGls:()=>(typeof GLOSSARY_CISM!=='undefined'?GLOSSARY_CISM:[]),
  ...
  cisa:  { name:'CISA',  fullName:'Certified Information Systems Auditor',        org:'ISACA', icon:'🔍',  color:'#f39c12', accentDark:'#d68910',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_CISA!=='undefined'?DOMAIN_NAMES_CISA:{}),
           getAcr:()=>(typeof ACRONYMS_CISA!=='undefined'?ACRONYMS_CISA:[]),
           getGls:()=>(typeof GLOSSARY_CISA!=='undefined'?GLOSSARY_CISA:[]),
  ...
  cissp: { name:'CISSP', fullName:'Certified Information Systems Security Professional', org:'ISC²', icon:'🛡️', color:'#e74c3c', accentDark:'#c0392b',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_CISSP!=='undefined'?DOMAIN_NAMES_CISSP:{}),
           getAcr:()=>(typeof ACRONYMS_CISSP!=='undefined'?ACRONYMS_CISSP:[]),
           getGls:()=>(typeof GLOSSARY_CISSP!=='undefined'?GLOSSARY_CISSP:[]),
  ...
  crisc: { name:'CRISC', fullName:'Certified in Risk and Information Systems Control', org:'ISACA', icon:'⚠️', color:'#9b59b6', accentDark:'#8e44ad',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_CRISC!=='undefined'?DOMAIN_NAMES_CRISC:{}),
           getAcr:()=>(typeof ACRONYMS_CRISC!=='undefined'?ACRONYMS_CRISC:[]),
           getGls:()=>(typeof GLOSSARY_CRISC!=='undefined'?GLOSSARY_CRISC:[]),
  ...
  issap: { name:'ISSAP', fullName:'Information Systems Security Architecture Professional', org:'ISC²', icon:'🏗️', color:'#1abc9c', accentDark:'#16a085',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_ISSAP!=='undefined'?DOMAIN_NAMES_ISSAP:{}),
           getAcr:()=>(typeof ACRONYMS_ISSAP!=='undefined'?ACRONYMS_ISSAP:[]),
           getGls:()=>(typeof GLOSSARY_ISSAP!=='undefined'?GLOSSARY_ISSAP:[]),
  ...
  secx:  { name:'SecurityX', fullName:'CompTIA SecurityX (CASP+)', org:'CompTIA', icon:'🔐', color:'#e67e22', accentDark:'#ca6f1e',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_SECX!=='undefined'?DOMAIN_NAMES_SECX:{}),
           getAcr:()=>(typeof ACRONYMS_SECX!=='undefined'?ACRONYMS_SECX:[]),
           getGls:()=>(typeof GLOSSARY_SECX!=='undefined'?GLOSSARY_SECX:[]),
  ...
  chfi:  { name:'CHFI', fullName:'Computer Hacking Forensic Investigator', org:'EC-Council', icon:'🔬', color:'#c0392b', accentDark:'#a93226',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_CHFI!=='undefined'?DOMAIN_NAMES_CHFI:{}),
           getAcr:()=>(typeof ACRONYMS_CHFI!=='undefined'?ACRONYMS_CHFI:[]),
           getGls:()=>(typeof GLOSSARY_CHFI!=='undefined'?GLOSSARY_CHFI:[]),
  ...
  ecih:  { name:'ECIH', fullName:'EC-Council Certified Incident Handler', org:'EC-Council', icon:'🚨', color:'#2980b9', accentDark:'#2471a3',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_ECIH!=='undefined'?DOMAIN_NAMES_ECIH:{}),
           getAcr:()=>(typeof ACRONYMS_ECIH!=='undefined'?ACRONYMS_ECIH:[]),
           getGls:()=>(typeof GLOSSARY_ECIH!=='undefined'?GLOSSARY_ECIH:[]),
  ...
  cpent: { name:'CPENT', fullName:'Certified Penetration Testing Professional', org:'EC-Council', icon:'⚔️', color:'#d35400', accentDark:'#ba4a00',
           ...
           getDN:()=>(typeof DOMAIN_NAMES_CPENT!=='undefined'?DOMAIN_NAMES_CPENT:{}),
           getAcr:()=>(typeof ACRONYMS_CPENT!=='undefined'?ACRONYMS_CPENT:[]),
           getGls:()=>(typeof GLOSSARY_CPENT!=='undefined'?GLOSSARY_CPENT:[]),
